      ...
      {open && (
        <dialog 
          ...
          <div className='w-125 h-50 bg-[#1a222e] rounded-2xl p-5 text-white'>
            <button onClick={() => setOpen(!open)} className='float-end px-4 py-2
              text-white bg-[#11161D] rounded-md border-white cursor-pointer'>
              close
            </button>
            <h3 className='text-2xl mb-5'>Item details</h3>
